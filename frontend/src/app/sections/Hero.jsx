  ...
  return (
    <section className='hero-section px-6 md:px-24 xl:px-40 w-full min-h-screen' id='1'>
        <div className='hero-headline mt-60'>
            ...
            <p className='text-center text-[16px] md:text-[20px] md:leading-body mt-12 w-3/4 mx-auto'>
            WE CONNECT - WE CREATE - WE GROW <br/>
            HELPING YOU BUILD YOUR DREAM DIGITAL PRESENCE IS OUR 1st GOAL
            </p>
        </div>
